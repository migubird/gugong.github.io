// Palace, Emperor, Figure, Event data for the interactive map
...
const PALACES = {
  "taihe-dian": {
    ...
    "width": 100,
    "height": 55,
    "description": "故宫最大的宫殿，皇帝登基、大婚、命将出征、万寿节（皇帝生日）等重大典礼场所。殿内正中设金漆雕龙宝座，上悬\"建极绥猷\"匾额。",
    "significance": "皇权象征，国家最高礼仪中心",
    "dimensions": {
      "width_m": 63.5,
      "depth_m": 37.2,
      "height_m": 35.05
  ...
  "zhonghe-dian": {
    ...
    "width": 55,
    "height": 50,
    "description": "皇帝去太和殿举行大典前在此休息、接受执事官朝拜之处。方形殿，四面开门。",
    "significance": "大典前的准备场所",
    "dimensions": {
      "width_m": 24.15,
      "depth_m": 24.15,
      "height_m": 19.7
  ...
  "baohe-dian": {
    ...
    "width": 90,
    "height": 50,
    "description": "明代大典前皇帝更衣之处。清代为除夕、正月十五皇帝宴饮外藩王公及公主额驸的场所，也是殿试考场。",
    "significance": "殿试场所，宴会厅",
    "dimensions": {
      "width_m": 53.4,
      "depth_m": 27.75,
      "height_m": 29.5
  ...
  "qianqing-gong": {
    ...
    "width": 90,
    "height": 45,
    "description": "明代至清初皇帝的寝宫和处理日常政务之所。清康熙前为皇帝寝宫，雍正后移至养心殿。\"正大光明\"匾后曾藏立储密匣。",
    "significance": "皇帝寝宫（清初前），理政中心",
    "dimensions": {
      "width_m": 45.3,
      "depth_m": 21.6,
      "height_m": 20.0
  ...
  "jiaotai-dian": {
    ...
    "width": 50,
    "height": 40,
    "description": "皇后生日、元旦、冬至接受朝贺之处。殿内正中设宝座，存放二十五方宝玺。后部设铜壶滴漏和自鸣钟。",
    "significance": "皇后礼仪场所，存放宝玺",
    "dimensions": {
      "width_m": 20.3,
      "depth_m": 16.8,
      "height_m": 16.5
  ...
  "kunning-gong": {
    ...
    "width": 85,
    "height": 45,
    "description": "明代皇后寝宫。清代改为祭神场所，东暖阁为皇帝大婚洞房。殿内设有萨满教祭祀设施，保留满族传统。",
    "significance": "皇后寝宫（明），祭神场所（清），大婚洞房",
    "dimensions": {
      "width_m": 42.8,
      "depth_m": 16.3,
      "height_m": 15.8
  ...
  "yanxi-gong": {
    ...
    "width": 60,
    "height": 40,
    "description": "东西六宫之一。清代多位妃嫔曾居此。宣统元年（1909）改建为西式三层\"水晶宫\"，因辛亥革命停工。",
    "significance": "妃嫔居所，晚清西洋建筑尝试",
    "dimensions": {},
    "color": "#8e44ad"
  },
  "chuxiu-gong": {
    ...
    "width": 60,
    "height": 40,
    "description": "西六宫之一。慈禧太后入宫时居于此，后为庆祝五十大寿斥巨资修缮。光绪大婚时，慈禧居于此宫。",
    "significance": "慈禧入宫居所",
    "dimensions": {},
    "color": "#8e44ad"
  },
  "yangxindian": {
    ...
    "width": 70,
    "height": 50,
    "description": "雍正起清代皇帝的寝宫和理政中心。\"勤政亲贤\"匾额下是皇帝日常办公之处。晚清慈禧太后在此垂帘听政。",
    "significance": "清雍正后皇帝实际寝宫，垂帘听政地",
    "dimensions": {},
    "color": "#c0392b"
  },
  "junji-chu": {
    ...
    "width": 35,
    "height": 25,
    "description": "雍正七年（1729）设立，清朝中后期实际最高权力机关。军机大臣在此每日觐见皇帝，处理军国大事。",
    "significance": "清代中后期最高决策机构",
    "dimensions": {},
    "color": "#7f8c8d"
  }
};
